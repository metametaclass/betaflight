...
ifeq ($(filter $(TARGET),$(F1_TARGETS) $(F3_TARGETS) $(F4_TARGETS) $(F7_TARGETS) $(G4_TARGETS) $(H7_TARGETS) $(SITL_TARGETS) $(SIMULATOR_LIBUV_TARGETS)),)
...
else ifeq ($(TARGET),$(filter $(TARGET), $(SIMULATOR_LIBUV_TARGETS)))
TARGET_MCU := SIMULATOR_LIBUV
SIMULATOR_BUILD = yes
USE_LIBUV = yes
